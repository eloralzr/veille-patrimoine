...
10. **Fraîcheur** : seules les sources datées du 1er septembre 2025 ou après sont acceptées ; pour une source antérieure, n'extrais rien et réponds `[]` ; sans date, demande-la avant d'extraire.
11. **Plusieurs acteurs dans un même texte** (article de synthèse) : une fiche par acteur cité, chacune avec son propre `acteur_id`.
