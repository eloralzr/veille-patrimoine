...
4. Nature : `disposition_initiale` pour le texte déposé par le Gouvernement ; `amendement` pour un amendement (groupe, rapporteur, commission, Gouvernement) ; `avis` pour une institution ; `chiffrage` pour un coût ou un rendement ; `reaction` pour une prise de position sans amendement.
